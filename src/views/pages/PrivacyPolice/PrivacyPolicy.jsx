      ...
      <div className="container">
        <div className="row justify-content-md-center">
          <div className="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-10 col-xxl-10 trams-condition-page">
            ...
            <p className="trams-title">We take your data privacy seriously</p>
            <div className="trams-condition-text-area">
              <p><br/>
              <br/>Effective Date: May 4th, 2025
              <br/>Last Updated: Aug 15, 2025<br/><br/>

txtviews.com (“we”, “us”, “our”) is committed to protecting your privacy and the security of your personal data. This Privacy Policy (“Policy”) applies to all products and/or services offered by us to all individuals (“you”, “your”, “user”). This Policy outlines how we collect, use, share, store, and safeguard your personal data when you access our website, mobile applications, or interact with us in any manner (collectively, the “platform”). Your trust is important to us, and we are transparent about our practices.

By using our Platform, you acknowledge that you have read and understood this Policy and consent to the collection and use of your personal data as described herein. If you do not agree, please refrain from accessing our Platform or services.</p><p>
...
We endeavor to collect only such personal data that is reasonably necessary to perform our services for you. When you interact with our Platform or otherwise with us, we may collect the following personal data from you directly:
<br/>
    1. General Data - your first name, last name, email, mobile number, address, country, state, gender, age or date of birth, application history and installation data;
    2. Technical and Network Activity Data - we might optionally collect data about your device and your usage of our Platform, including your IP address, device ID, user ID, hardware model and version, mobile network information, operating system and other online identifiers, type of browser, browsing history, search history, access time, pages viewed, URLs clicked on, forms submitted, and physical location;
    3. Authentication - data required for authentication, such as username, OTP, Captcha and password;
    4. Financial Data - your bank details, including account name, account number, IFSC code and credit card (last 4- digit number);
    5. SMS Data - We collect, transmit and store SMS data from your phone to verify and analyse your financial position, to determine your cash flow, credits, income, and spending pattern. Please note that such data is limited to details of the transactions contained in the SMS. Personal SMS data or sensitive information such as OTP, personal SMSs, account details, etc is filtered out and not stored.
<br/>
You can choose not to give us personal data when we ask you for it. If you decide not to give us your personal data, it may restrict some platform functionality.
</p><p>
...
You may choose to provide us with the data, which is essential for us to deliver the products and/or services you request. Without this data, we may not be able to provide you with all the requested products and/or services;
    ...
    For Subscription to our services or updates;
...
<br/>
<b>We do not collect or receive data about you from any third-party sources other than the financial data from integrated payment gateway or processors related to your purchases and asset transfers on our platform.</b> We process this data in accordance with this policy!
When you contact us for support or to share feedback or queries via Instagram or email, we may use relevant information from those communications, as well as any publicly available data associated with your profile, to assist you more effectively.
<br/>
</p><p>
...
We will collect personal data by lawful and fair means and, where appropriate, with the knowledge of the individual concerned. We only collect and process personal data about you where we have a lawful basis. Lawful basis on which we would process data from you includes:
    ...
    Processing for legitimate uses where processing is necessary in order to provide you with our products and/or services, such as:
        ...
        (iv) For legal and compliance reasons, such as the prevention, detection, or investigation of a crime, or loss prevention;
        (v) As otherwise described to you at the time of collection of your personal data.
        (vi) To improve services, refine credit risk evaluation, optimize platform performance, and support research and data analysis in collaboration with IT service providers.
</p><p>
...
We will use your personal data to:
    ...
    To register you on our Platform and/or for the events, seminars, etc.
    ...
    To provide multiple cashback rewards & offers to you for our products and/or services
    For marketing (where you have agreed to this) and for market research purposes, including internal demographic studies, to provide, optimize and personalize our products and/or services and data (where you have agreed to this) about our products and/or services
    ...
    To enhance personalized services and improve credit risk assessments
    To send you communication, including through WhatsApp business messages, in relation to your use of the Platform and/or Services
    ...
    Perform analytics, market research and segmentation to understand your preferences, improve our products and/or services and our communications to you.
    To make platform and its content available and to further optimize & develop it.
...
You have the following rights:
    ...
    Right of grievance redressal In case of any grievance, you can also raise a request to alter your consent choices at contact@txtviews.com.
    Right to withdraw your consent You can withdraw your consent easily by emailing us on contact@txtviews.com. The withdrawal of consent previously granted for the processing of personal data does not affect the lawfulness of the processing until the withdrawal. However, opting out will result in cessation of the respective services.

For exercising any of your rights, you can contact us using contact@txtviews.com. We will need you to furnish proof of your identity before you can exercise these rights. We may not be able to process any requests made in the event you fail to establish your identity, or if we are unable to authenticate your identity.
</p><p>
...
We may disclose your personal data will include:
    ...
    We may share personal data with third-party IT service providers, including Finbox to support our technology services and facilitate research or data analytics.
...
We do not knowingly collect data from individuals under 18. We do not encourage or participate in any behavioral monitoring of minors. We do not encourage or participate in any behavioral monitoring of adults without any explicit conset.
If we discover a child has provided personal data without parental consent, we will delete it promptly. Parents may contact us at contact@txtviews.com for data removal.</p><p>
...
If you decide not to comply with any new changes to this policy, you may continue to use the platform with restricted functionality.
